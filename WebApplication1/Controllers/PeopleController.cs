...
namespace WebApplication1.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Race,Gender")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Race,Gender")] Person person)
        {
            if (id != person.ID)
            {
                return NotFound();
